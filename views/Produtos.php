                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <input id="descricao" name="descricao" type="text" class="form-control"
                               placeholder="Ex: Leite condensado muito gostoso">
                    </div>
                    <div class="col-12 mb-2">
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <input id="estoqueMinimo" name="estoqueMinimo" type="text" class="form-control"
                               placeholder="Ex: 5">
                    </div>
                    <div class="col-12 mb-2">
                        <label for="validade">Validade</label>
                        <input id="validade" name="validade" type="text" class="form-control"
                               placeholder="Ex: 11/11/2025">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        <label for="desconto"><span class="float-left">Desconto:</span>
                            <div class="float-left ml-1"><i class="fas fa-calculator" data-toggle="tooltip"
                                                            title="Calcular desconto" onclick="calcDesconto()"></i>
                            </div>
                        </label>
                    ...
                    <div class="col-4 client-box mb-4 " id="<?php echo $produto['id']; ?>">
                        <div class="row">
                            ...
                            <input id="estoqueMinimo-<?php echo $produto['id']; ?>" type="hidden"
                                   value="<?php echo $produto['estoqueMinimo']; ?>">
                            <div class="col-12">
                            ...
                            <div class="col-12 text-right d-flex mt-1">
                                <div id="edit-<?php echo $produto['id']; ?>" class="btn-success"
                                     onclick="efetuarVenda(<?php echo $produto['id']; ?>)">Efetuar venda
                                </div>
                            </div>
